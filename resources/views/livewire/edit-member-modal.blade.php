                ...
                <form wire:submit.prevent="save" class="space-y-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            ...
                            <input wire:model="nickname" type="text" {!! !$canEdit ? 'disabled' : '' !!} placeholder="Panggilan akrab" class="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl text-sm text-slate-900 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition outline-none shadow-sm disabled:bg-slate-50 disabled:text-slate-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group">
                                ...
                                <input wire:model="birth_place" type="text" {!! !$canEdit ? 'disabled' : '' !!} placeholder="Kota" class="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl text-sm text-slate-900 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition outline-none shadow-sm disabled:bg-slate-50 disabled:text-slate-500">
                            </div>
                        </div>
                        <div class="space-y-1.5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            ...
                            <textarea wire:model="address" rows="2" {!! !$canEdit ? 'disabled' : '' !!} placeholder="Alamat lengkap..." class="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl text-sm text-slate-900 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition outline-none shadow-sm resize-none disabled:bg-slate-50 disabled:text-slate-500"></textarea>
                        </div>
                    </div>
